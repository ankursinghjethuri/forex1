          ...
          <div className="md:flex">
            <div className="md:shrink-0 md:w-1/2 relative overflow-hidden hidden md:block">
              ...
              <img 
                ...
                src="https://images.pexels.com/photos/4665064/pexels-photo-4665064.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" 
                alt="Data visualization"
              />
              <div className="absolute inset-0 flex items-center justify-center p-6">
                <div className="text-white text-center">
                  <h2 className="text-2xl font-bold mb-2">Join Trendy AI</h2>
                  <p>Create an account to start analyzing your data with AI.</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-8 md:p-10 md:w-1/2">
              <div className="text-center mb-8 md:hidden">
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Join Trendy AI</h2>
                <p className="text-gray-600 dark:text-gray-300">Create an account to get started</p>
              </div>
